                            ...
                            <tbody>
                                @foreach($student->marks as $m)
                                    <tr>
                                        ...
                                        <td style="padding: 2px 4px; font-size: 0.6rem; text-align: center; font-weight: bold; color: #4b5563; text-transform: uppercase;">{{ isset($m->teacher->name) ? (count($parts = array_filter(explode(' ', $m->teacher->name))) > 1 ? reset($parts) . ' ' . end($parts) : reset($parts)) : 'TR' }}</td>
                                    </tr>
                                @endforeach
                                <!-- Overall Average Row -->
