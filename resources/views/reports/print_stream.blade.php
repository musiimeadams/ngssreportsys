...
<body class="bg-slate-950 p-4 md:p-8 min-h-screen flex flex-col items-center">
    ...
    <div class="w-full max-w-4xl no-print flex justify-between items-center mb-6 bg-slate-900 border border-slate-800 p-4 rounded-2xl shadow-lg text-slate-100">
        ...
        <div class="flex gap-3">
            <a href="{{ route('reports.download_word', $schoolClass->id) }}" 
                class="px-4 py-2 bg-emerald-600 hover:bg-emerald-500 text-white text-sm font-semibold rounded-xl flex items-center gap-2 shadow transition duration-200 cursor-pointer no-underline">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2.5" stroke="currentColor" class="w-4 h-4">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M3 16.5v2.25A2.25 2.25 0 0 0 5.25 21h13.5A2.25 2.25 0 0 0 21 18.75V16.5M16.5 12 12 16.5m0 0L7.5 12m4.5 4.5V3" />
                </svg>
                Download Word (.doc)
            </a>
            <a href="{{ route('reports.download_html', $schoolClass->id) }}" 
                class="px-4 py-2 bg-blue-600 hover:bg-blue-500 text-white text-sm font-semibold rounded-xl flex items-center gap-2 shadow transition duration-200 cursor-pointer no-underline">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2.5" stroke="currentColor" class="w-4 h-4">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M3 16.5v2.25A2.25 2.25 0 0 0 5.25 21h13.5A2.25 2.25 0 0 0 21 18.75V16.5M16.5 12 12 16.5m0 0L7.5 12m4.5 4.5V3" />
                </svg>
                Download HTML
    ...
    @foreach($students as $student)
        <div class="w-full max-w-4xl bg-slate-900/60 border border-slate-800/80 rounded-3xl p-8 md:p-12 shadow-2xl print-border academic-border mb-8 page-break relative">
            <!-- Left Leafy Border -->
            ...
            <div class="grid grid-cols-5 gap-6 mb-6">
                ...
                <div class="col-span-3 legend-container border border-slate-800 rounded-xl p-4 bg-slate-950/40 text-[10px]">
                ...
                <div class="col-span-2 legend-container border border-slate-800 rounded-xl p-4 bg-slate-950/40 text-[10px]">
                    <table class="w-full text-left text-[9px] text-slate-400">
                        <thead>
                            <tr class="border-b border-slate-800 text-white font-bold uppercase">
            ...
            <!-- Remarks Section -->
            <div class="space-y-4 mb-6 pt-3 border-t border-slate-800/80 text-xs text-slate-300">
